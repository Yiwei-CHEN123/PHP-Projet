...
function RenvoyerEtude($cx, $num_rapport, $temps, $matricule) {
    $requete = "UPDATE Rapports SET Etat='Ouvert' WHERE NumeroR='$num_rapport';";
	$requete2 = "Insert into SuiviEdition(DateHeure, Commentaire, MatriculeE, NumeroR) VALUES ('$temps', 'Renvoyé à étude', '$matricule', '$num_rapport');";
    $result = mysqli_query($cx, $requete);
	mysqli_query($cx, $requete2);
...
function CloturerRapport($cx, $num_rapport, $temps, $matricule) {
    $requete = "UPDATE Rapports SET Etat='Cloturé' WHERE NumeroR='$num_rapport';";
	$requete2 = "Insert into SuiviEdition(DateHeure, Commentaire, MatriculeE, NumeroR) VALUES ('$temps', 'Clôturé', '$matricule', '$num_rapport');";
    $result = mysqli_query($cx, $requete);
	mysqli_query($cx, $requete2);
...
function EnvoyerDirecteur($cx, $num_rapport, $temps, $matricule) {
    $requete = "UPDATE Rapports SET Etat='Soumis' WHERE NumeroR='$num_rapport';";
	$requete2 = "Insert into SuiviEdition(DateHeure, Commentaire, MatriculeE, NumeroR) VALUES ('$temps', 'Soumis', '$matricule', '$num_rapport');";
    $result = mysqli_query($cx, $requete);
	mysqli_query($cx, $requete2);
